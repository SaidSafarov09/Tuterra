    ...
    const features = [
        {
            ...
            desc: 'Бот в Telegram пришлет уведомление об уроке, напомнит об оплате и соберет отчет за день. Робот работает — вы отдыхаете.',
            color: '#8B5CF6',
        },
        {
            icon: ShieldCheck,
            title: 'Финансовая прозрачность',
            desc: 'Автоматический учет каждой копейки. Информация о доходах, долгах и истории транзакций всегда перед глазами в наглядных графиках.',
            color: '#10B981',
        },
        {
            icon: Smartphone,
            title: 'Мобильность без компромиссов',
            desc: 'Управляйте учебным процессом с любого устройства. Современный адаптивный интерфейс работает так же быстро, как нативное приложение.',
            color: '#4A6CF7'
        },
    ]
        ...
        <section className={styles.hero}>
            ...
            <div className={styles.container}>
                ...
                >
                    ...
                    >
                        <Zap size={16} fill="currentColor" /> ЭКОСИСТЕМА ДЛЯ РЕПЕТИТОРОВ
                    </motion.div>

                    <h1 className={styles.title}>
                        ИТ-экосистема для<br />
                    ...
                    <p className={styles.description}>
                        Ваш личный ассистент, который берет на себя рутину:<br />
                        от расписания и контроля оплат до уведомлений в <span className={styles.gradientText}>Telegram</span>.
                    </p>
