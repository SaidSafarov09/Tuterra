                ...
                <div className={styles.grid}>
                    ...
                    >
                        ...
                        <div className={styles.list}>
                            {[
                                {
                                    t: 'Заметки и блокноты',
                                    d: 'Разрозненные записи, которые превращаются в кашу. Сложно быстро найти историю пропущенных уроков или оплат.'
                                },
                                {
                                    t: 'Ручные напоминания',
                                    d: 'Приходится каждый раз писать ученикам вручную. Это отнимает время и создает неловкие ситуации при напоминании о долгах.'
                                },
                                {
                                    t: 'Потерянный фокус',
                                    d: 'Голова занята цифрами и графиком, а не подготовкой к занятиям. Выгорание наступает быстрее, чем растет доход.'
                                }
                            ].map((item, i) => (
                    ...
                    >
                        ...
                        <div className={styles.list}>
                            {[
                                {
                                    t: 'Автопилот в Telegram',
                                    d: 'Бот сам пришлет уведомление об уроке и корректно напомнит ученику об оплате, сохраняя ваши нервы и время.'
                                },
                                {
                                    t: 'Умный контроль долгов',
                                    d: 'Система подсвечивает неоплаченные уроки и считает общую задолженность. Вы видите реальную картину своих финансов.'
                                },
                                {
                                    t: 'Порядок в документах',
                                    d: 'История занятий, контакты и заметки по каждому ученику доступны в один клик с любого устройства.'
                                }
                            ].map((item, i) => (
                                <div key={i} className={styles.item}>
