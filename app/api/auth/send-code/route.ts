...
export async function POST(request: NextRequest) {
    try {
        ...
        const testEmails = ['test@test.ru', 'test2@test.ru', 'testx@test.ru', 'testx2@test.ru', 'testx3@test.ru', 'testx4@test.ru', 'demo@demo.ru', 'admin@admin.com', 'demo@tuterra.ru', 'test@tuterra.ru']
